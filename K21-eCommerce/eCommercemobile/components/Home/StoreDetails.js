                            ...
                            {showCommentsStore && commentsStore !== null && (
                                <>
                                    ...
                                    {user === null || user.role !== 'BUYER' ? "" : <>
                                        <View style={[MyStyles.row, { alignItems: "center", justifyContent: "center" }]}>
                                            <TextInput value={contentCommentStore} onChangeText={t => setContentCommentStore(t)} style={{ height:40, width: 290, backgroundColor: "lightgray", padding: 5, margin:5 }} placeholderTextColor="gray"  placeholder="Nội dung bình luận..." />
                                ...
                                <Modal
                                    ...
                                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)'}}>
                                        <View style={{ backgroundColor:"white", width:"80%", height:160, padding:15, borderRadius:10}}>
                                    ...
                                    right={() => 
                                        <View>
                                            ...
                                            <View>
                                                ...
                                                <TouchableOpacity onPress={() => setReplyingCommentStoreId(c.id)} style={{ marginLeft: 5, padding:2 }}>
                                                    <Text style={{ color: 'green' }}>Phản hồi</Text>
                                                </TouchableOpacity>
                                            </View>
                                        )}
                                            {user && user.id !== c.buyer.id && (
                                                <TouchableOpacity onPress={() => setReplyingCommentStoreId(c.id)} style={{ marginLeft: 10, padding:2 }}>
                                                    <Text style={{ color: 'green' }}>Phản hồi</Text>
                                                </TouchableOpacity>
                                            )}
                                        </View>
