...
const AddTag = ({ route }) => {
    ...
    return (
        <View style={[MyStyles.container, MyStyles.margin, { marginTop: 100, marginHorizontal:30 }]}>
            ...
            <Text style={{ fontSize:16, fontWeight:"bold", marginTop:20, marginBottom:10 }}>Vui lòng chọn sản phẩm để gắn tag</Text>
            ...
            <TextInput
                ...
                value={tag}
                onChangeText={setTag}
                style={[MyStyles.inputLog, {marginBottom:10, backgroundColor:"white"}]}
                label="Thêm tag mới..."
            />
