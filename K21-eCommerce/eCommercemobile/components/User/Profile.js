                    ...
                    <>
                        ...
                        {user.role === 'SELLER' && (
                            <>
                                {userStore ? (
                                    !storeStatus ? (
                                        <Text style={{color:"red"}}>Cửa hàng của bạn đang đợi phê duyệt</Text>
                                    ) : (
                                        <>
                                            ...
                                            <TouchableOpacity style={[MyStyles.buttonLog, { backgroundColor: 'white', borderWidth:3, borderRadius:20, marginVertical:5, borderColor:"orange" }]} onPress={() => navigation.navigate("StoreProduct", { "store_id": userStore.id })}>
                                                <Text style={{ textAlign: "center", color: 'black', fontSize:16, fontWeight:"bold" }}>Danh sách sản phẩm của cửa hàng</Text>
                                            </TouchableOpacity>
                                        </>
                                    )
                                ) : (
                                    <TouchableOpacity style={[MyStyles.buttonLog, { backgroundColor: 'white', borderWidth:3, borderRadius:20, marginVertical:5, borderColor:"orange" }]} onPress={() => navigation.navigate("RegisterStore", { 'user_id': user.id })}>
